...
class ExecuteProcess(MyView):
    def __init__(self, request):
        ...
        super(ExecuteProcess, self).__init__(request, name='namewps_execute', title='')

    def breadcrumbs(self):
        breadcrumbs = super(ExecuteProcess, self).breadcrumbs()
        breadcrumbs.append(dict(route_path=self.request.route_path('namewps_list'), title='NAME processes'))
    ...
    @view_config(route_name='namewps_execute', renderer='../templates/execute.pt', accept='text/html')
    def view(self):
